"""
Django settings for Product Comparison Site project.

This file contains all the necessary configurations for running the Django
backend of the Product Comparison Site. It includes settings for database
connections, static and media file handling, security, and third-party
integrations.
